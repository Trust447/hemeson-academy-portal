...
//       // Removed 'type' because the error says it doesn't exist in your table
//       const { data: term, error: termErr } = await (supabase
//         .from('terms')
//         .select('id, name, is_current, session:sessions(name)')
//         .eq('is_current', true)
//         .maybeSingle() as any);

//       if (termErr || !term) {
//         throw new Error("No active academic term found. Please contact admin.");
//       }

//       // 2. Validate PIN and Admission Number
...
//       // 3. Usage Check
//       if (pinRecord.usage_count >= pinRecord.max_uses) {
//         setUsageExceeded(true);
//         return;
//       }

//       // 4. Fetch Scores (Changed 'grades' to 'scores' to match your DB)
...
//       await supabase
//         .from('result_pins')
//         .update({ usage_count: pinRecord.usage_count + 1 })
//         .eq('id', pinRecord.id);

//       // 6. Map to data structure
//       const finalResult = {
//         student: {
//           ...pinRecord.student,
...
//         term: {
//           id: term.id,
//           type: term.name || "Regular", // Using 'name' since 'type' doesn't exist
//           session: { name: term.session?.name || "Current Session" }
//         },
//         scores: scores || [],
//         usage: {
//           count: pinRecord.usage_count + 1,
//           max: pinRecord.max_uses,
//           remaining: pinRecord.max_uses - (pinRecord.usage_count + 1)
//         }
//       };

//       setResultData(finalResult);
//       toast({ title: "Results Loaded", description: "Successfully retrieved records." });
...
//                 <img src="/hemeson-logo.png" alt="Logo" className="w-16 h-16" />
//               </div>
//             </Link>
//           </div>
//           <CardTitle className="text-2xl font-bold">PinGuard Portal</CardTitle>
//           <CardDescription>Enter details to view your report card</CardDescription>
//         </CardHeader>
